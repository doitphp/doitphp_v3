...
abstract class Controller {
    ...
    public function __construct() {
        ...
        //实例化视图对象
        self::$_viewObject = $this->_initView();
     ...
     * @return mixed
     */
    public static function request($key = null, $default = null, $isEncode = true) {

        return Request::request($key, $default, $isEncode);
    }
     ...
     * @return boolean
     */
    public function setCookie($cookieName, $value, $expire = null) {

        return $this->instance('Cookie')->set($cookieName, $value, $expire);
    }
    ...
    public static function instance($className) {
        ...
        $libraryArray = array('Cookie', 'Session', 'Pagination', 'Captcha', 'Image', 'Validation', 'Curl', 'File', 'Text', 'CacheRedis', 'CacheMemcached', 'CacheFile', 'Client', 'FileDownload', 'FileUpload', 'Tree', 'MongoDb', 'Csv', 'Language', 'Encrypt', 'Calendar', 'HttpResponse');
    ...
    public static function ext($extensionName) {
        ...
        return Extension::loadExtensions($extensionName);
    }
     ...
     * @param integer $code Http状态码, 默认: 200 ok
     * @return string
     */
    public function ajax($status = true, $msg = null, $data = array(), $code = 200) {

        return Response::ajax($status, $msg, $data, $code);
    }
    ...
    protected function _initView() {
        ...
        //分析视图类文件路径
        $filePath = DOIT_ROOT . '/core/View.php';
    ...
    public function __call($method, $args) {
        ...
        switch ($method) {
            ...
            case 'env':
                return call_user_func_array(array('doitphp\core\Request', 'env'), $args);

            case 'server':
                return call_user_func_array(array('doitphp\core\Request', 'server'), $args);

            case 'files':
                return call_user_func_array(array('doitphp\core\Request', 'files'), $args);

...
class DbCommand {
    ...
    public function from($tableName, $fields = null) {
        ...
        //对数据表字段的分析
        if ($fields && !is_array($fields) && func_num_args() > 2) {
     ...
     * @access public
     *
     * @param integer $offset 启始id
     * @param integer $listCount 显示的行数
     *
     * @return object
     */
    public function limit($offset, $listCount) {
     ...
     * @access protected
     *
     * @param string|array $fieldsName 所要查询的数据表字段信息
     *
     * @return string
     */

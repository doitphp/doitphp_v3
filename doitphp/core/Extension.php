...
abstract class Extension extends Controller {
    ...
    public function getExtName() {
        ...
        return substr(get_class($this), 11, -3);
    }
     ...
     * @access object
     */
    final public static function loadExtensions($extensionName) {
        ...
        if (!isset(self::$_extensionObjArray[$extensionName])) {
            ...
            self::$_extensionObjArray[$extensionName] = App::singleton('extensions\\' . $extensionName . 'Ext');
        }

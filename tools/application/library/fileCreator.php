...
class fileCreator {
	 ...
	 * @return string
	 */
	public static function fileNote($fileName = null, $info = null, $author = null, $copyright = null, $package = null, $license = null, $link = null) {
	 ...
	 *
	 * @access public
	 * @param array $fields 不能为空的参数
	 * @return string
	 */
	public static function parseParams($fields) {
